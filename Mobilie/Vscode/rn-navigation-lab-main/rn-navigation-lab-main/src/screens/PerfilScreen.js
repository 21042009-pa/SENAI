  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.cartao}>
        ...
        <Text style={styles.nome}>Paula Sbrissa Gianotto</Text>
        <Text style={styles.email}>paula.gianotto@email.com</Text>
        ...
        <View style={styles.infoLinha}>
          ...
          <Text style={styles.infoValor}>9</Text>
        </View>
        <View style={styles.infoLinha}>
          <Text style={styles.infoLabel}>Membro desde</Text>
          <Text style={styles.infoValor}>Maio 2023</Text>
        </View>
      </View>

      {/* TODO: mudar o texto do botao para o contexto do seu tema */}
      <TouchableOpacity style={styles.botao}>
        <Text style={styles.botaoTexto}>Editar perfil Jogames</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
}
